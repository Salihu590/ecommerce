...
const SpecialOffersSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        Order Today And{' '}
        <span className="bg-black text-white font-extrabold px-2 py-1 rounded">Save Up To 70%!</span>
      </motion.h2>
      <p className="text-center max-w-3xl mx-auto text-gray-600 mb-10">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed semper dolor lacus, nec ornare velit cursus sed. Cras in consectetur arcu, eu auctor mi.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        >
            ...
            <div>
              ...
              <div className="text-xs text-gray-200 mb-4">
                {`${timeLeft.days.toString().padStart(2, '0')} : ${timeLeft.hours
                  ...
                  .toString()
                  .padStart(2, '0')} : ${timeLeft.seconds.toString().padStart(2, '0')} Days Hours Mins Secs`}
              </div>
            </div>
            <button
          ...
          {/* Image */}
          <img src="/images/best-deals.jpg" alt="Best Deals" className="mt-4 h-80 w-full object-cover rounded-lg" />
        </motion.div>
        ...
        >
          ...
          {/* Image */}
          <img src="/images/low-fat-meat.jpg" alt="Low Fat Meat" className="mt-4 h-80 w-full object-cover rounded-lg" />
        </motion.div>
        ...
        >
          ...
          {/* Image */}
          <img src="/images/fresh-fruit.jpg" alt="Summer Sale" className="mt-4 h-80 w-full object-cover rounded-lg" />
        </motion.div>
      </div>
    </motion.section>
  );
