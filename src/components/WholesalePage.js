      ...
      <main className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center">
                  <img
                    src="https://res.cloudinary.com/dsci2gspy/image/upload/v1755536514/your-mission-icon_g4z9lt.png"
          ...
          <div className="order-1 md:order-2 relative pt-8 pb-32 md:pb-0">
            <img
              src="https://res.cloudinary.com/dsci2gspy/image/upload/v1755536632/wholesale-food-market_gybtq9.jpg"
              ...
              <div className="flex items-center space-x-3">
                <div className="flex -space-x-2 overflow-hidden">
                  <img
                    ...
                    src="https://res.cloudinary.com/dsci2gspy/image/upload/v1755532256/user1_xjr1tv.png"
                    alt="Customer 1"
                  />
                  <img
                    className="inline-block h-10 w-10 rounded-full ring-2 ring-white"
